    ...
    connectedCallback() {
        ...
        if (!InstallButton.isSupported || !InstallButton.isAllowed) {
            ...
            this.renderRoot.innerHTML = !InstallButton.isAllowed
                ? "<slot name='not-allowed'>您只能在 HTTPS 网站或本地主机上安装 ESP 设备。</slot>"
                : "<slot name='unsupported'>您的浏览器不支持在 ESP 设备上安装内容。请使用 Mozilla Firefox、Google Chrome 或 Microsoft Edge。</slot>";
            return;
        }
